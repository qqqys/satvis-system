<template>
  <div
    class="container"
    style="background-image: url(../src/assets/back.jpg); background-size: 100%;"
  >
    <div
      style="z-index: 1000;"
      id="cesiumContainer"
    ...
    >
      ...
      <change-menu :class="{blur:isshow}"></change-menu>
      <!-- <web-socket @cmsg="fmsg"></web-socket> -->
      
      <div >
      <button class="cesium-button cesium-toolbar-button cesium-home-button pos" @click.stop=" ()=>{isshow = !isshow}">
      </button>
      </div>
    </div>
    <ObjectMenu v-show="isshow"></ObjectMenu>
  </div>
</template>
...
export default defineComponent({
  ...
  setup() {
    onMounted(() => {
      ...
      let tempLoc = Cesium.Cartesian3.fromDegrees(
