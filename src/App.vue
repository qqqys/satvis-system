...
export default defineComponent({
  ...
  setup() {
    onMounted(() => {
      ...
      createSat(window.viewer, {
        MessageType: "Modify",
        UserName: "admin",
        TargetObject: "Sat11",
        TargetType: "3DModel",
        Rx: -8204011.227106312,
        Ry: 27988689.29170859,
        Rz: 22881.078117065277,
        Q0: 0.06960732292279612,
        Q1: -0.13115933126259527,
        Q2: 0.6951183221640737,
        Q3: -0.7033936085934204,
      });
      changePos(window.viewer, {
        MessageType: "Modify",
        UserName: "admin",
        TargetObject: "Sat11",
        TargetType: "3DModel",
      ...
      let beam = {
        ...
        BeamOwner: "Sat11",
        BeamAngle: 45.0,
        Q0: 0.07079291577751037,
        Q1: -0.10252227335897969,
        Q2: 0.5878841539890991,
        Q3: -0.7992932928716132,
        BeamLength: 36678833.231044546,
      };
      createBeam(window.viewer, beam);
      changeBeamDir(window.viewer, beam);
